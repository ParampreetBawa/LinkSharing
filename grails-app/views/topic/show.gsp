	...
	<body>
		...
		<div id="show-topic" class="content scaffold-show" role="main">
			...
			<ol class="property-list topic">
				...
				<g:if test="${topicInstance?.isPrivate}">
				<li class="fieldcontain">
					<span id="isPrivate-label" class="property-label"><g:message code="topic.isPrivate.label" default="Is Private" /></span>
					
						<span class="property-value" aria-labelledby="isPrivate-label"><g:formatBoolean boolean="${topicInstance?.isPrivate}" /></span>
