	...
	<body>
		...
		<div id="show-subscription" class="content scaffold-show" role="main">
			...
			<ol class="property-list subscription">
				...
				<g:if test="${subscriptionInstance?.seriousnessLevel}">
				<li class="fieldcontain">
					<span id="seriousnessLevel-label" class="property-label"><g:message code="subscription.seriousnessLevel.label" default="Seriousness Level" /></span>
					
						<span class="property-value" aria-labelledby="seriousnessLevel-label"><g:fieldValue bean="${subscriptionInstance}" field="seriousnessLevel"/></span>
