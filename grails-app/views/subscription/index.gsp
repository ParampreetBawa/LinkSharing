		...
		<div id="list-subscription" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="seriousnessLevel" title="${message(code: 'subscription.seriousnessLevel.label', default: 'Seriousness Level')}" />
				...
				<g:each in="${subscriptionInstanceList}" status="i" var="subscriptionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${subscriptionInstance.id}">${fieldValue(bean: subscriptionInstance, field: "seriousnessLevel")}</g:link></td>
