...
<div class="fieldcontain ${hasErrors(bean: userResourceInstance, field: 'resource', 'error')} required">
	...
	<g:select id="resource" name="resource.id" from="${com.intelligrape.linksharing.Resource.list()}" optionKey="id" required="" value="${userResourceInstance?.resource?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: userResourceInstance, field: 'user', 'error')} required">
	...
	<g:select id="user" name="user.id" from="${com.intelligrape.linksharing.User.list()}" optionKey="id" required="" value="${userResourceInstance?.user?.id}" class="many-to-one"/>
