...
<div class="fieldcontain ${hasErrors(bean: inviteInstance, field: 'sentBy', 'error')} required">
	...
	<g:select id="sentBy" name="sentBy.id" from="${com.intelligrape.linksharing.User.list()}" optionKey="id" required="" value="${inviteInstance?.sentBy?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: inviteInstance, field: 'sentTo', 'error')} required">
	...
	<g:select id="sentTo" name="sentTo.id" from="${com.intelligrape.linksharing.User.list()}" optionKey="id" required="" value="${inviteInstance?.sentTo?.id}" class="many-to-one"/>
